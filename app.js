...
// array.reduce(function(total,currentVlaue,currentIndex,array){},initialValue);

// var result = myarrs.reduce(function(total,curvalue,curidx,arr){
	// console.log('this is toal = ',total); // 0 undefined // if we use 1 parameter 10 underfined
	// console.log('this is curvalue = ',curvalue);//10 to 100 by number // if we use 1 parameter 20 to 100 by number
	// console.log('this is curidx = ',curidx);//0 to 9 index number // if we use 1 parameter 1 to 9 by index number
